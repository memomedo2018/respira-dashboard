...
RELEASE_DATA_PATHS = [BASE_DIR / 'data' / '.htaccess', BLOG_DIR, BASE_DIR / 'data' / 'blog_topics.json', BASE_DIR / 'data' / 'blog_generation_log.json', BASE_DIR / 'data' / 'seo_audit.json', BASE_DIR / 'data' / 'seo_brain_log.json', STORE_FILE, SITE_FILE, BASE_DIR / 'data' / 'product-schema.json', AI_CATALOG_FILE]
